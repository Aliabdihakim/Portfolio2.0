...
const GetInTouch = () => {
  ...
  return (
    <motion.div
      className="relative rounded-xl p-1 backdrop-blur-lg"
      initial="initial"
    ...
    >
      <PageWrapper>
        <CardContainer className="flex flex-col gap-6 rounded-[11px] p-4 mt-32">
          <div className="flex gap-12 max-md:flex-col">
            ...
            <div className="flex flex-col justify-center px-4">
              <h1 className="mb-2 bg-gradient-to-r from-black to-black/70 bg-clip-text text-3xl font-bold text-transparent dark:from-zinc-100 dark:to-zinc-400">
                Feel free to reach out to me!
              </h1>

              <div className="my-8">
                <a className="bg-red-500 rounded-full px-4 py-2 text-sm text-white">
                  ali.abdihakim.ali1@gmail.com
                </a>
              </div>
            </div>
          </div>
